...
namespace DataTimePicker
{
    ...
    public class Picker : Control
    {
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(DateTime?), typeof(Picker), new FrameworkPropertyMetadata(DateTime.Now, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(Picker.OnValueChanged), new CoerceValueCallback(Picker.CoerceValue), true, System.Windows.Data.UpdateSourceTrigger.PropertyChanged));


        static void OnValueChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            (d as Picker)._blockManager.Render();
        }
    ...
    internal class BlockManager
    {
        ...
        public BlockManager(Picker dameer, string format)
        {
